            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black dark:text-white">
                ...
                <span className="inline-block align-baseline">
                  <span className="text-[#79b072] dark:text-[#0a8a3f] font-mono" aria-live="polite" aria-atomic="true">
                    {scrambled}
                  </span>
                </span>
              </h1>

              <p className="text-xl sm:text-lg text-gray-700 dark:text-gray-300">

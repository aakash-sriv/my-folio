        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              ...
              <div className="aspect-square rounded-2xl bg-[linear-gradient(135deg,#f97316,#ec4899)] flex items-center justify-center shadow-2xl">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[linear-gradient(135deg,#f97316,#ec4899)] rounded-full blur-3xl opacity-20 -z-10"></div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
              ...
              <p>
                With hands-on experience from my internship at XcodeTeam and recognition as a <span className="font-bold text-orange-500">Top 1% performer</span> at PwC, I bring both technical skills and a passion for continuous growth. When I'm not coding, you'll find me solving problems on LeetCode or exploring new frameworks and tools.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6">
              {stats.map((stat, idx) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-6 h-6 mx-auto mb-2 text-orange-500" />
